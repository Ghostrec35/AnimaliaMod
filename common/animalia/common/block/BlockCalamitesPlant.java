...
public class BlockCalamitesPlant extends Block implements IPlantable
{
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        return (block == Block.grass.blockID || block == Block.sand.blockID || block == Block.dirt.blockID || block == this.blockID);
    }
    ...
    {
        return Animalia.itemCalamites.itemID;
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("animalia:calamites");
    }
}
