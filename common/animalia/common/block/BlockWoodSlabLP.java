...
public class BlockWoodSlabLP extends BlockHalfSlab
{
	private Block modelBlock;

	public BlockWoodSlabLP(int id, boolean isdouble, Block model)
    {
    ...
    {
        return Animalia.woodSlabLP.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer player, int par6, float par7, float par8, float par9)
    {
    	...
    	if(current != null && current == new ItemStack(this) && !this.isDoubleSlab
    		...
    		par1World.setBlock(par2, par3, par4, Animalia.woodSlabLPDouble.blockID, meta, 3);
    		return true;
    	}
    	return false;
    }
    */
    ...
    {
        return new ItemStack(Animalia.woodSlabLP.blockID, 2, par1 & 7);
    }
