...
public class ItemCalamites extends Item
{
    /** The ID of the block the calamites will spawn when used from inventory bar. */
    private int spawnID;

    public ItemCalamites(int par1)
    {
        super(par1);
        this.spawnID = Animalia.plantCalamites.blockID;
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(IconRegister par1IconRegister)
    {
        this.itemIcon = par1IconRegister.registerIcon("animalia:item_calamites");
    }
