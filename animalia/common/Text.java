...
/**
 * An Enumeration of Colors containing the String values, Hexadecimal integer values, and RGB values for each color in Minecraft
 * 
 * @author Ghostrec35
...
public final class Text
{
	public enum TextColor
	{
		 ...
		 * 
		 * @return String that can be added to the beginning of another String to specify coloration in Minecraft
		 **/
		...
		/**
		 *Retrieves an int Array to retrieve the RGB values for the specified Color. 
		 *Index 0 is the Red value, Index 1 is the Green value, and Index 2 is the Blue value.  
		 *
